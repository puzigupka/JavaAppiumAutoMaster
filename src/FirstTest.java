...
//    }
    @Test
    public void saveTwoArticleToMyListHomeWork()
    {
        waitForElementAndClick(
                By.id("org.wikipedia:id/search_container"),
                "Cannot find 'Search Wikipedia' input",
        ...
        waitForElementAndClick(
                By.xpath("//*[@resource-id='org.wikipedia:id/page_list_item_container']//*[@text='Apple Watch']"),
                "Cannot find 'Apple Watch' input",
                5
        );
        ...
        waitForElementAndClick(
                ...
                "Cannot find 'My reading list' input",
                5
        );
        ...
        waitForElementNotPresent(
                By.xpath("//*[@resource-id='org.wikipedia:id/page_list_item_container']//*[@text='Apple Watch']"),
                "'Apple Watch' is still present on the page",
                5
