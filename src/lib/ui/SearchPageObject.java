...
public class SearchPageObject extends MainPageObject
{
    ...
    {
        this.assertElementNotPresent(By.xpath(SEARCH_RESULT_ELEMENT), "we supposed not to any results");
    }
...
//
//
//        this.waitForElementPresent(By.xpath(search_result_by) , "Error", 15);
//
//        this.assertElementPresent(search_result_by, "as title article " + title);
//    }
//
//
//    public void assertElementPresent(String by, String error_message){
//        int amount_of_elements = getAmountOfElements();
//        if (amount_of_elements == 0 ) {
//            String default_message = "An element '" + by + "' cannon found";
