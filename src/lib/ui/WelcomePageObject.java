...
public class WelcomePageObject extends MainPageObject
{
    private static final String
            ...
            STEP_LEARN_MORE_ABOUT_DATA_COLLECTED_LINK = "id:Learn more about data collected' link",
            NEXT_LINK = "id:Next",
    ...
    {
        this.waitForElementPresent(STEP_ADD_OR_EDIT_PREFERRED_LANG_LINK, "Cannot find 'Help make the app better' link", 10);
    }
