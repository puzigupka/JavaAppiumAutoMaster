...
public class MainPageObject
{
    ...
    public WebElement waitForElement(String locator, String error_massage, long timeoutInSeconds)
    {
        WebElement element = waitForElementPresent(locator, error_massage,timeoutInSeconds);
        return element;
    }
    ...
    public void swipeUpElementToLeft(String locator, String error_message)
    {
